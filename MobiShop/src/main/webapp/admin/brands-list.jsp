	...
	<div class="container-right">
		<div class="">
			...
			<div class="title-section">
				...
				<div class="menu-link">
					<span class="item"> <a
						href='<c:url value="/admin/brand?action=detail" />'><i
							class="fa-solid fa-plus icon"></i>Thêm nhãn hiệu</a>
					</span>
				</div>
			</div>
											...
											<tr>
												...
												<td class="action">
													<div class="btn-group action-group">
														<a class="btn btn-default btn-sm" href='<c:url value="/admin/brand?action=detail&id=${item.id}" />'>Xem</a>

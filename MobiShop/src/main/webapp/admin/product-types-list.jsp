	...
	<div class="container-right">
		<div class="">
			...
			<div class="title-section">
				...
				<div class="menu-link">
					<span class="item"> <a
						href='<c:url value="/admin/productType?action=detail" />'><i
							class="fa-solid fa-plus icon"></i>Thêm loại sản phẩm</a>
					</span>
				</div>
			</div>
									...
									<tbody>
										<c:forEach var="item" items="${paging.data}">
											<tr>
												...
												<td><a href='<c:url value="/admin/productType?action=detail&id=${item.id}" />'><img alt=""
														src="../assets/images/product-types/${item.fileName}"></a></td>
												<td>${item.code}</td>
												...
												<td class="action">
													<div class="btn-group action-group">
														<a class="btn btn-default btn-sm" href='<c:url value="/admin/productType?action=detail&id=${item.id}" />'>Xem</a>

...
<link rel="stylesheet" type="text/css" href="assets/css/product-type-detail.css">
		...
		<div class="">
			<div class="head-section">
				<ul>
					...
					<li><a href='<c:url value="/admin/productType" />'>Loại sản phẩm</a></li>
			...
			<div class="content-section">
				<form action="${pageContext.request.contextPath}/admin/productType" method="POST" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									...
									<div class="col-md-9">
										<div class="file-upload">
											...
											<label for="_file">
												<img id="result_photo" alt="" src="../assets/images/product-types/${detail.fileName}" onerror="this.style.display='none'">
											</label>
										</div>
									</div>
								</div>
...
<script type="text/javascript" src="assets/js/product-type-detail.js"></script>